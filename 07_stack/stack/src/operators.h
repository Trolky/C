 ...
 */
typedef calc_num_type(*calc_type)(calc_num_type, calc_num_type);
...
struct calc_oper_type {
    ...
    calc_type handler;  /*!< Přidružená aritmetická operace. */
};
 ...
 * @return calc_type Ukazatel na obslužnou funkci, nebo konstanta NULL pokud operátor nebyl nalezen v poli OPERATORS.
 */
calc_type get_operator_handler(char operator);
