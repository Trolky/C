...
/**
 * \brief Definice typu ukazatele na obslužnou funkci matematické operace s dvěma operandy.
 */
typedef float (*calc_func_type)(float, float);
 ...
 */
int main() {
    calc_func_type handler; /* vs float (*handler)(float, float); */
