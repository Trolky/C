...
int main() {
    ...
    /* Vytvoření rotační matice. */     /* TODO vytvo5it 3D spiralu, zmeni se spiral dimension*/
    ...
    /* Na co jsme zapomněli? uvolnit matici */
    matrix_deinit(&rotation_matrix);
    free(spiral_points);
